# Zaibatsu Shadowraiders Component Sheet Transcript (English)

Grouped transcript of the English component sheets used to verify Shadowraiders records.

## Source Set

- `sh-en-blocks-a4` - `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 01 Blocks A4 (en).pdf` (en, role `blocks-a4`, SHA-256 `cd7c6985bdc0d6ea7a2efa8a79e0674506a26e9a921cbb050a2a74f8c7d669c6`)
- `sh-en-control-cards` - `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 02 Control Cards (en).pdf` (en, role `control-cards`, SHA-256 `7c35672f5fdcd19251ff1037a7f4574f78548d55ef66214f01786dc9a02a60b3`)
- `sh-en-action-cards` - `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 03 Action Cards (en).pdf` (en, role `action-cards`, SHA-256 `c9b46bf7704f1ae283e7c83cdacbcf7117bc288d87bac25c3d2d8bac8fa821ee`)
- `sh-en-pawns` - `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 04 Pawns A Color.pdf` (en, role `pawns`, SHA-256 `2c51dc22eae73caefbb6f2d52c5ae0aedb00e5f181624246d75604c1f55b9ebf`)
- `sh-en-markers` - `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 05 Markers A Color.pdf` (en, role `markers`, SHA-256 `b13a1a3390c2f9d7e85cfd78696df9bc2bee34e13f96a0ab0442c126910156fa`)
- `sh-en-chaos-card` - `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 06 Chaos Card.pdf` (en, role `chaos-card`, SHA-256 `8bda0df51c9f14436d24424221e411a3ff328f20d5076359f6a4e350f8e4ceb9`)
...
## Artifact `sh-en-blocks-a4`

- Source path: `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 01 Blocks A4 (en).pdf`
- Language: `en`
- Role: `blocks-a4`
- Authority: `primary`
...
## Artifact `sh-en-control-cards`

- Source path: `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 02 Control Cards (en).pdf`
- Language: `en`
- Role: `control-cards`
- Authority: `primary`
...
## Artifact `sh-en-action-cards`

- Source path: `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 03 Action Cards (en).pdf`
- Language: `en`
- Role: `action-cards`
- Authority: `primary`
...
## Artifact `sh-en-pawns`

- Source path: `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 04 Pawns A Color.pdf`
- Language: `en`
- Role: `pawns`
- Authority: `primary`
...
## Artifact `sh-en-markers`

- Source path: `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 05 Markers A Color.pdf`
- Language: `en`
- Role: `markers`
- Authority: `primary`
...
## Artifact `sh-en-chaos-card`

- Source path: `DOCS/Original/ShadowRaiders/Zaibatsu Shadowraiders 2017-06-28 (en)/Sh 06 Chaos Card.pdf`
- Language: `en`
- Role: `chaos-card`
- Authority: `primary`
