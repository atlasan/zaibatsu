...
| 2 - block geometry | Hex canvas, six edges, boundary-space and space-adjacency editing | Exported block passes cross-reference checks and shows source overlay |
