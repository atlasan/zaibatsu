...
| Movement and phase flow | full transcript | full transcript | `DOCS/rules/speedrunners/turns-and-actions.md`, `DOCS/rules/shadowraiders/pawns-threats-and-combat.md` | Speedrunners base movement and explicit attachment-granted movement activation live; granted stealth, richer movement-use modes, and mode-specific movement remain pending | yes (base) | yes (base) | yes (base) | `partial` |
