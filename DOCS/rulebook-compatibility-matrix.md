...
| Movement and phase flow | full transcript | full transcript | `DOCS/rules/speedrunners/turns-and-actions.md`, `DOCS/rules/shadowraiders/pawns-threats-and-combat.md` | Speedrunners base movement, explicit attachment-granted movement activation, and granted-move `perTurn` / `d6` budgets live; granted stealth and mode-specific movement remain pending | yes (base) | yes (base) | yes (base) | `partial` |
...
| Icebreaker and control | full transcript | full transcript | same as above | ICE faces, black-ICE penalties, attachment ICE modifiers, and space ICE modifiers now resolve; exact source-backed ICE data and Shadowraiders control variants remain pending | yes (base) | yes (base) | yes (base) | `partial` |
